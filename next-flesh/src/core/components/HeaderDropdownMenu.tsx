  ...
  return (
    <div className="relative">
      <div className="flex items-center justify-center">
        <button type="button" className="no-focus">
          <img
      ...
      <ul className="py-1 mt-2 absolute text-sm origin-top-right right-0 bg-white border rounded-lg shadow-lg w-64">
        <li>
        ...
        <li>
          <a href="/" className="flex items-center py-2 px-3 hover:bg-gray-100">
